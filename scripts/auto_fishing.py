...
scheduler.every(5).minutes.do(action.set_keep_item_in_car, [ITEM_OCTOPUS_NAME, ITEM_TUNA_NAME]).tag('item_keep')
scheduler.every(10).minutes.do(action.set_take_item_in_car, {ITEM_FISHING_BAIT_NAME: '50'}).tag('item_take')
